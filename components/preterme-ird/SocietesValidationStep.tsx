...
export function SocietesValidationStep({
  ...
  const saveRow = async (id: string) => {
    ...
    setSavingId(id);
    try {
      await updatePretermeIrdClient(id, {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Toutes validées */}
      {allValidated && (
        <Card className="bg-emerald-50 border-emerald-200 dark:bg-emerald-950/30 dark:border-emerald-700/50">
