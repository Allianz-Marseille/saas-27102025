/**
 * GET /api/admin/preterme-auto/trello-lists
 *
 * Récupère la liste des colonnes (lists) d'un tableau Trello.
 * Utilisé depuis le formulaire de configuration pour aider l'admin
 * à sélectionner la colonne cible par nom plutôt que par ID.
 *
 * Query params :
...
export async function GET(req: NextRequest) {
  ...
  // Trier par position et retourner uniquement ce dont le client a besoin
  const lists = raw
