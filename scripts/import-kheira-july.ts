...
/**
 * Script pour importer les actes de santé individuelle de Kheira pour juillet 2025
 * 
 * Ce script :
 * 1. Récupère l'ID utilisateur de Kheira via son email
 * 2. Importe les actes dans la collection health_acts avec dateSaisie = 01/07/2025
 * 3. Respecte les dates d'effet réelles de chaque acte
 * 
 * Usage: npm run import:kheira-jul
 */
...
const DATE_SAISIE = new Date('2025-07-01T00:00:00'); // 1er juillet 2025
const MOIS_KEY = '2025-07'; // Juillet 2025

// Données des actes à importer
const ACTES_TO_IMPORT = [
  {
    kind: 'REVISION',
    clientNom: 'Mme Consales',
    numeroContrat: '168425815',
    dateEffet: new Date('2025-08-01T00:00:00'),
    caAnnuel: 3232.47,
    compagnie: 'Allianz',
  },
  {
  ...
  {
    kind: 'REVISION',
    clientNom: 'Mme Aguirre',
    numeroContrat: '168588084',
    dateEffet: new Date('2025-08-01T00:00:00'),
    caAnnuel: 891.62,
    compagnie: 'Allianz',
  },
  {
    kind: 'REVISION',
    clientNom: 'Riahi Hichem',
    numeroContrat: '168651583',
    dateEffet: new Date('2025-08-01T00:00:00'),
    caAnnuel: 504.20,
    compagnie: 'Allianz',
  },
  {
    ...
    clientNom: 'Guvercin Sait',
    numeroContrat: 'Rep5251',
    dateEffet: new Date('2025-08-01T00:00:00'),
    caAnnuel: 810.20,
    compagnie: 'Allianz',
  },
  {
    kind: 'ADHESION_SALARIE',
    clientNom: 'Gay Bertrand',
    numeroContrat: 'Pi17372ce001',
    dateEffet: new Date('2025-08-01T00:00:00'),
    caAnnuel: 2488.48,
    compagnie: 'Allianz',
  },
  {
    kind: 'ADHESION_SALARIE',
    clientNom: 'Manikowsk Martial',
    numeroContrat: 'Pia054dca000',
    dateEffet: new Date('2025-08-01T00:00:00'),
    caAnnuel: 485.13,
    compagnie: 'Allianz',
  },
  ...
  try {
    ...
    for (const acte of ACTES_TO_IMPORT) {
      try {
        ...
        const kindLabel = acte.kind === 'REVISION' ? 'RÉV' : 'ADH';
