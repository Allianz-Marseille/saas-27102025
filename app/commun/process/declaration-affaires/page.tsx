...
const PORTFOLIO_H91358 = [
  { name: "Corentin", range: "A → C" },
  { name: "Emma", range: "D → F" },
  { name: "Audrey", range: "G → M" },
  { name: "Donia", range: "N → Z" },
];

const PORTFOLIO_H92083 = [
  { name: "Joëlle", range: "A → H" },
  { name: "Astrid", range: "I → Z" },
];
