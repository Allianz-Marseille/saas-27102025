  ...
  return (
    <RouteGuard>
      <div className="flex h-screen overflow-hidden">
        ...
        {/* Boutons flottants pour collapse - Desktop uniquement */}
        {isCollapsed && (
          <button
            onClick={() => setIsCollapsed(false)}
            className="hidden lg:flex fixed left-16 top-1/2 -translate-y-1/2 z-50 bg-gradient-to-r from-green-500 to-emerald-600 text-white p-3 rounded-r-xl shadow-2xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-110 group"
        ...
        {!isCollapsed && (
          <button
            ...
            className="hidden lg:flex fixed left-64 top-1/2 -translate-y-1/2 z-50 bg-gradient-to-r from-emerald-600 to-green-600 text-white p-3 rounded-r-xl shadow-2xl hover:shadow-emerald-500/50 transition-all duration-300 hover:scale-110 group"
