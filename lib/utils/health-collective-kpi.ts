...
import { getHealthCommissionRate } from "./health-kpi";
...
export function calculateHealthCollectiveKPI(acts: HealthCollectiveAct[]): HealthCollectiveKPI {
  ...
  // Calculer le seuil atteint et les commissions (réutiliser la fonction de santé individuelle)
  const commissionInfo = getHealthCommissionRate(kpisByType.caPondere);
