...
| Dispenses mutuelle obligatoire | `dispenses-mutuelle-obligatoire.md` | `due-contrat-groupe.md`, `reglementaire-due-standard.md` |
| Rédiger une DUE (contrat groupe) | `due-contrat-groupe.md`, `reglementaire-due-standard.md` | `references.md`, `dispenses-mutuelle-obligatoire.md` |
...
| Différence régime général / SSI | `regime-general.md`, `regimes-socle-comparatif.md`, `ro/ssi.md` | `regimes-obligatoires-tns.md`, `regimes-obligatoires-ccn.md` |
...
| Régime TNS vs salarié | `regimes-socle-comparatif.md`, `regime-general.md`, `regimes-obligatoires-tns.md`, `regimes-obligatoires-ccn.md` | `ro/ssi.md`, `synthese-comparative-ro-tns.md` |
