...
/**
 * Script pour importer les actes de santé individuelle de Kheira pour mai 2025
 * 
 * Ce script :
 * 1. Récupère l'ID utilisateur de Kheira via son email
 * 2. Importe les actes dans la collection health_acts avec dateSaisie = 01/05/2025
 * 3. Respecte les dates d'effet réelles de chaque acte
 * 
 * Usage: npm run import:kheira-may
 */
...
const DATE_SAISIE = new Date('2025-05-01T00:00:00'); // 1er mai 2025
const MOIS_KEY = '2025-05'; // Mai 2025

// Données des actes à importer
const ACTES_TO_IMPORT = [
  {
    kind: 'REVISION',
    clientNom: 'Estors Josette',
    numeroContrat: '168420675',
    dateEffet: new Date('2025-05-01T00:00:00'),
    caAnnuel: 2237.07,
    compagnie: 'Allianz',
  },
  {
    kind: 'REVISION',
    clientNom: 'Fournie Bernard',
    numeroContrat: '168508340',
    dateEffet: new Date('2025-06-01T00:00:00'),
    caAnnuel: 3055.32,
    compagnie: 'Allianz',
  },
];
