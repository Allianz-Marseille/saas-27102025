...
`;
    ...
    // Si c'est un démarrage M+3 avec message vide, utiliser le message d'amorce
    let messageText = message || "";
    if (isM3Mode && uiEvent === "m3-start" && !messageText.trim()) {
      messageText = "Démarrer le workflow M+3";
    }
