...
import type { Collaborateur, CollaborateurInput, JourTravail, Pole } from "@/types/collaborateur";
import {
  POLE_LABELS,
  JOURS_LABELS,
  JOURS_ORDER,
...
export default function CollaborateursPage() {
  ...
  function openEdit(c: Collaborateur) {
    ...
    setForm({
      ...
      pole: c.pole,
      joursParSemaine: c.joursParSemaine,
      joursTravail: [...c.joursTravail],
    });
    setDialogOpen(true);
  }
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <span
                    className={`inline-block mt-1 px-2 py-0.5 rounded-full text-[11px] font-medium border ${POLE_COLORS[c.pole]}`}
                  >
                    {POLE_LABELS[c.pole]}
                  </span>
                </div>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={form.pole}
                onValueChange={(v) => setForm((f) => ({ ...f, pole: v as Pole }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={String(form.joursParSemaine)}
                onValueChange={(v) => setForm((f) => ({ ...f, joursParSemaine: Number(v) }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">
                {JOURS_ORDER.filter((j) => form.joursTravail.includes(j))
