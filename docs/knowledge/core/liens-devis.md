...
- **Devis GAV / Garantie Accident de la Vie** : https://www.allianz.fr/assurance-particulier/famille-loisirs/protection-de-la-famille/garantie-des-accidents-de-la-vie-privee/devis-contact.html/?codeAgence=H91358
...
- **Assurance énergies renouvelables** : https://www.allianz.fr/assurance-particulier/habitation-biens/assurance-equipements/installations-energies-renouvelables/devis-contact.html/?codeAgence=H91358
...
- **Protection Juridique — Mes droits au quotidien** : https://www.allianz.fr/assurance-particulier/famille-loisirs/protection-juridique/mes-droits-au-quotidien/devis-contact.html/?codeAgence=H91358

---

## Contact et rendez-vous

- **Formulaire de contact (rendez-vous)** : https://www.allianz.fr/assurance-particulier/infos-contact/rendez-vous-avec-mon-conseiller.html#/rendezvous/?codeAgence=H91358

---

## Utilisation dans les communications

### Pour l'IA et les échanges avec les clients

Lorsqu'un client exprime un besoin d'assurance, l'IA doit :

1. **Identifier le type de besoin** du client
2. **Recommander le lien de devis approprié**
3. **Fournir le lien cliquable** dans la réponse
4. **Expliquer brièvement** ce que le client peut faire avec ce lien

### Format de présentation

**Exemple pour un devis auto** :
> Pour obtenir un devis personnalisé pour votre assurance auto, je vous invite à compléter notre formulaire en ligne : [Devis Auto](https://www.allianz.fr/forms/api/context/sharing/quotes/auto?codeAgence=H91358)
> 
> Ce devis est gratuit, sans engagement et adapté à votre profil. Vous recevrez une réponse sous 24-48h.

**Exemple pour un devis habitation** :
> Pour votre assurance habitation, vous pouvez réaliser un devis en ligne personnalisé : [Devis Habitation](https://www.allianz.fr/forms/api/context/sharing/fast-quotes/household?codeAgence=H91358)
> 
> Le formulaire prend quelques minutes et vous permettra d'obtenir une estimation adaptée à votre logement.

### Points d'attention

- **Tous les liens incluent le code agence H91358** pour que les devis soient bien attribués à l'agence
- **Les devis sont gratuits et sans engagement**
- **Encourager le client** à compléter le formulaire en ligne pour une réponse rapide
- **Proposer un rendez-vous** si le besoin est complexe ou si le client préfère un accompagnement personnalisé
