    ...
    <div className={cn(
      ...
      <div className="flex items-start gap-3">
        <Building2 className={cn(
          ...
          row.saved ? "text-emerald-400" : "text-amber-400"
        )} />
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-0.5 flex-wrap">
            <span className="text-[10px] text-slate-500">N° {client.numeroContrat}</span>
            <Badge
              variant="outline"
              className={cn(
                "text-[10px] h-4",
          ...
          <div className="space-y-1">
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="h-8 text-sm bg-slate-800 border-slate-600 uppercase flex-1"
                onKeyDown={(e) => {
...
export function SocietesValidationStep({
  ...
  if (rows.length === 0) {
    return (
      <div className="flex items-center gap-3 p-6 bg-emerald-950/20 border border-emerald-800/40 rounded-xl text-sm text-emerald-300">
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Info brouillon */}
      <div className="flex items-start gap-2 p-3 bg-slate-800/40 border border-slate-700 rounded-lg text-xs text-slate-400">
      ...
      {/* Toutes validées */}
      {allValidated && (
        <div className="flex items-center gap-3 p-4 bg-emerald-950/30 border border-emerald-700/50 rounded-xl text-sm text-emerald-300">
          <CheckCircle2 className="h-5 w-5 shrink-0" />
          <div>
