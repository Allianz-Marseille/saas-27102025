            ...
            <CardContent className="p-8 relative z-10">
              <div className="flex items-center gap-6">
                ...
                <div className="relative">
                  <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-emerald-500 via-teal-500 to-emerald-600 flex items-center justify-center text-white shadow-2xl shadow-emerald-500/50 card-3d neon-border relative overflow-hidden group">
                ...
                <div className="flex-1">
                  <h2 className="text-3xl font-black bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent mb-2 neon-text">
                    {firstName} {lastName}
                  </h2>
                  <div className="flex items-center gap-2 mb-3">
                    <Badge className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold px-3 py-1 shadow-lg">
                      <Stethoscope className="h-3 w-3 mr-1" />
                      Commercial Santé Collective
                    </Badge>
                    <Badge 
                      variant="outline" 
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="border-0 shadow-2xl glass-morphism overflow-hidden relative card-3d group">
              ...
              <CardContent className="space-y-4 relative z-10">
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-teal-500/10 transition-all duration-300 card-3d">
                  <div className="p-2 bg-teal-500/20 rounded-lg neon-border">
                    <Shield className="h-5 w-5 text-teal-600 dark:text-teal-400" />
                  </div>
                  <div className="flex-1">
                    <p className="text-sm text-muted-foreground font-bold">Rôle</p>
                    <Badge className="mt-1 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold shadow-lg">
          ...
          {/* Carte d'informations de domaine */}
            <Card className="border-0 shadow-2xl glass-morphism overflow-hidden relative card-3d group">
              ...
              <CardContent className="relative z-10">
                <div className="p-6 rounded-xl bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 border-2 border-emerald-500/50 glass-morphism relative overflow-hidden group">
                  <div className="absolute inset-0 holographic opacity-10 group-hover:opacity-20 transition-opacity" />
                  <div className="flex items-center gap-4 relative z-10">
                    <div className="p-4 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl shadow-2xl shadow-emerald-500/50 neon-border">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground font-semibold mt-1">
                        Gestion des contrats de santé collective et calcul des commissions
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <CardContent className="relative z-10">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  { icon: <Shield className="h-8 w-8" />, label: "Fiabilité", color: "from-emerald-500 to-teal-500", achieved: true },
                  ...
                  >
                    ...
                    {achievement.achieved && (
                      <div className="absolute -top-2 -right-2">
                        <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-xl border-2 border-emerald-500">
