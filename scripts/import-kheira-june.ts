...
/**
 * Script pour importer les actes de santé individuelle de Kheira pour juin 2025
 * 
 * Ce script :
 * 1. Récupère l'ID utilisateur de Kheira via son email
 * 2. Importe les actes dans la collection health_acts avec dateSaisie = 01/06/2025
 * 3. Respecte les dates d'effet réelles de chaque acte
 * 
 * Usage: npm run import:kheira-jun
 */
...
const DATE_SAISIE = new Date('2025-06-01T00:00:00'); // 1er juin 2025
const MOIS_KEY = '2025-06'; // Juin 2025

// Données des actes à importer
const ACTES_TO_IMPORT = [
  {
    kind: 'ADHESION_SALARIE',
    clientNom: 'Mme Veron Melina',
    numeroContrat: 'Pi56405ca000',
    dateEffet: new Date('2025-06-02T00:00:00'),
    caAnnuel: 1766.25,
    compagnie: 'Allianz',
  },
  {
    kind: 'REVISION',
    clientNom: 'Gonzalez Emmanuel',
    numeroContrat: '168317799',
    dateEffet: new Date('2025-07-01T00:00:00'),
    caAnnuel: 4113.05,
    compagnie: 'Allianz',
  },
  {
    kind: 'REVISION',
    clientNom: 'Frediani Chloé',
    numeroContrat: '168441254',
    dateEffet: new Date('2025-07-01T00:00:00'),
    caAnnuel: 1177.68,
    compagnie: 'Allianz',
  },
